...
namespace Amanoi.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Create_Data = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Villas",
                columns: new[] { "Id", "Create_Data", "Description", "ImageUrl", "Name", "Occupancy", "Price", "Sqft", "Update_Date" },
                values: new object[,]
                {
